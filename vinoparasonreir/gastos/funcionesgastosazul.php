...
function gastos_azul($accion=NULL, $form=NULL, $anno)
{
	...
	$cadena='<form name="fgastos" id="fgastos"><table style="border:1px solid #FFFFFF" cellpadding="1" cellspacing="0" align="center">
				...
				<tr>
					<td colspan="15" bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">VINO GASTOS MENSUALES <select name="anno" id="anno" onchange="xajax_gastos_azul(\'\',\'\',this.value)">';
