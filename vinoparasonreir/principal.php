...
<div id="top" style="width:100%; height: 81px; background-color: #6d2e0d; top: 0px;  position: fixed; z-index:999;"><div id="logo" style="position: absolute; left:10px; top:5px;"><span style="color: #fff; font-family: Arial; font-size: 30px;">vino para sonreír</span></div>
