<?php
function gastos_jack($accion=NULL, $form=NULL, $anno)
{
	...
	{	
		...
		case 'editgastojack':
			...
			{
				mysql_query("UPDATE gastos_montos SET Fecha='".$form["anno"]."-".$form["mes"]."-".$form["dia"]."',
	...
	$cadena='<form name="fgastos" id="fgastos"><table style="border:1px solid #FFFFFF" cellpadding="1" cellspacing="0" align="center">
				<tr>
					<td colspan="27" bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">| <a href="#" onclick="lightbox.style.visibility=\'visible\'; xajax_agregar_gasto_jack()">Agregar Gasto</a> |</td>
				...
				<tr>
					...
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF"><a href="#" onclick="xajax_gastos_jack(\'sumachecks\', xajax.getFormValues(\'fgastos\'), \''.$anno.'\')">Calcular</a></td>
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">';if($sumaenero>0){$cadena.='$ '.number_format($sumaenero,2);}$cadena.='</td>
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">';if($sumafebrero>0){$cadena.='$ '.number_format($sumafebrero,2);}$cadena.='</td>
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">';if($sumamarzo>0){$cadena.='$ '.number_format($sumamarzo,2);}$cadena.='</td>
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">';if($sumaabril>0){$cadena.='$ '.number_format($sumaabril,2);}$cadena.='</td>
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">';if($sumamayo>0){$cadena.='$ '.number_format($sumamayo,2);}$cadena.='</td>
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">';if($sumajunio>0){$cadena.='$ '.number_format($sumajunio,2);}$cadena.='</td>
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">';if($sumajulio>0){$cadena.='$ '.number_format($sumajulio,2);}$cadena.='</td>
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">';if($sumaagosto>0){$cadena.='$ '.number_format($sumaagosto,2);}$cadena.='</td>
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">';if($sumaseptiembre>0){$cadena.='$ '.number_format($sumaseptiembre,2);}$cadena.='</td>
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">';if($sumaoctubre>0){$cadena.='$ '.number_format($sumaoctubre,2);}$cadena.='</td>
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">';if($sumanoviembre>0){$cadena.='$ '.number_format($sumanoviembre,2);}$cadena.='</td>
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">';if($sumadiciembre>0){$cadena.='$ '.number_format($sumadiciembre,2);}$cadena.='</td>
					<td bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">
				</tr>
				<tr>
					<td colspan="27" bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">JACK GASTOS MENSUALES <select name="anno" id="anno" onchange="xajax_gastos_jack(\'\',\'\',this.value)">';
	...
	$ResGastos=mysql_query("SELECT * FROM gastos WHERE Tipo='jack' ORDER BY Concepto ASC");
	...
	while($RResGastos=mysql_fetch_array($ResGastos))
	{
		...
		$cadena.='<tr>
					<td id="row_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolor.'" align="center" class="texto" style="border:1px solid #FFFFFF"><a href="#" class="Ntooltip" onclick="xajax_gastos_jack(\'checkall\', \''.$A.'\', \''.$anno.'\')">'.$A.'</a></td>
					
					<td id="con_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolor.'" align="left" class="texto" style="border:1px solid #FFFFFF"><a href="#" class="Ntooltip" onclick="lightbox.style.visibility=\'visible\'; xajax_editar_gasto_jack_nuevo_monto(\''.$RResGastos["Id"].'\', \''.$anno.'\')">'.$RResGastos["Concepto"].'</a></td>'; $bgcolor="#CCCCCC";
		
		$cadena.='<td id="enec_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolorene.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResEnero["Cantidad"])){		$cadena.='<input type="checkbox" name="check_'.$ResEnero["Id"].'" id="check_'.$ResEnero["Id"].'" value="1"';			if($form["check_".$ResEnero["Id"]]==1 OR $form==$A){		$sumaconcepto=$sumaconcepto+$ResEnero["Cantidad"];$cadena.=' checked';}$cadena.='>'; 		$tenero=$tenero+$ResEnero["Cantidad"];}$cadena.='</td>';				
		$cadena.='<td id="ene_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolorene.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResEnero["Cantidad"])){		$cadena.='<a href="#" class="Ntooltip" onclick="lightbox.style.visibility=\'visible\'; xajax_editar_gasto_jack(\''.$RResGastos["Id"].'\', \''.$ResEnero["Id"].'\', \''.$anno.'\')">$ '.number_format($ResEnero["Cantidad"],2).'<span>'.$ResEnero["Comentarios"].'</span></a>';}					$cadena.='</td>';				
		$cadena.='<td id="febc_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolorfeb.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResFebrero["Cantidad"])){		$cadena.='<input type="checkbox" name="check_'.$ResFebrero["Id"].'" id="check_'.$ResFebrero["Id"].'" value="1"';		if($form["check_".$ResFebrero["Id"]]==1 OR $form==$A){		$sumaconcepto=$sumaconcepto+$ResFebrero["Cantidad"];$cadena.=' checked';}$cadena.='>'; 		$tfebrero=$tfebrero+$ResFebrero["Cantidad"];}$cadena.='</td>';			
		$cadena.='<td id="feb_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolorfeb.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResFebrero["Cantidad"])){		$cadena.='<a href="#" class="Ntooltip" onclick="lightbox.style.visibility=\'visible\'; xajax_editar_gasto_jack(\''.$RResGastos["Id"].'\', \''.$ResFebrero["Id"].'\', \''.$anno.'\')">$ '.number_format($ResFebrero["Cantidad"],2).'<span>'.$ResFebrero["Comentarios"].'</span></a>';}			$cadena.='</td>';
		$cadena.='<td id="marc_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolormar.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResMarzo["Cantidad"])){		$cadena.='<input type="checkbox" name="check_'.$ResMarzo["Id"].'" id="check_'.$ResMarzo["Id"].'" value="1"';			if($form["check_".$ResMarzo["Id"]]==1 OR $form==$A){		$sumaconcepto=$sumaconcepto+$ResMarzo["Cantidad"];$cadena.=' checked';}$cadena.='>'; 		$tmarzo=$tmarzo+$ResMarzo["Cantidad"];}$cadena.='</td>';				
		$cadena.='<td id="mar_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolormar.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResMarzo["Cantidad"])){		$cadena.='<a href="#" class="Ntooltip" onclick="lightbox.style.visibility=\'visible\'; xajax_editar_gasto_jack(\''.$RResGastos["Id"].'\', \''.$ResMarzo["Id"].'\', \''.$anno.'\')">$ '.number_format($ResMarzo["Cantidad"],2).'<span>'.$ResMarzo["Comentarios"].'</span></a>';}					$cadena.='</td>';
		$cadena.='<td id="abrc_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolorabr.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResAbril["Cantidad"])){		$cadena.='<input type="checkbox" name="check_'.$ResAbril["Id"].'" id="check_'.$ResAbril["Id"].'" value="1"';			if($form["check_".$ResAbril["Id"]]==1 OR $form==$A){		$sumaconcepto=$sumaconcepto+$ResAbril["Cantidad"];$cadena.=' checked';}$cadena.='>'; 		$tabril=$tabril+$ResAbril["Cantidad"];}$cadena.='</td>';				
		$cadena.='<td id="abr_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolorabr.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResAbril["Cantidad"])){		$cadena.='<a href="#" class="Ntooltip" onclick="lightbox.style.visibility=\'visible\'; xajax_editar_gasto_jack(\''.$RResGastos["Id"].'\', \''.$ResAbril["Id"].'\', \''.$anno.'\')">$ '.number_format($ResAbril["Cantidad"],2).'<span>'.$ResAbril["Comentarios"].'</span></a>';}					$cadena.='</td>';
		$cadena.='<td id="mayc_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolormay.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResMayo["Cantidad"])){		$cadena.='<input type="checkbox" name="check_'.$ResMayo["Id"].'" id="check_'.$ResMayo["Id"].'" value="1"';				if($form["check_".$ResMayo["Id"]]==1 OR $form==$A){			$sumaconcepto=$sumaconcepto+$ResMayo["Cantidad"];$cadena.=' checked';}$cadena.='>'; 		$tmayo=$tmayo+$ResMayo["Cantidad"];}$cadena.='</td>';					
		$cadena.='<td id="may_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolormay.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResMayo["Cantidad"])){		$cadena.='<a href="#" class="Ntooltip" onclick="lightbox.style.visibility=\'visible\'; xajax_editar_gasto_jack(\''.$RResGastos["Id"].'\', \''.$ResMayo["Id"].'\', \''.$anno.'\')">$ '.number_format($ResMayo["Cantidad"],2).'<span>'.$ResMayo["Comentarios"].'</span></a>';}					$cadena.='</td>';
		$cadena.='<td id="junc_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolorjun.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResJunio["Cantidad"])){		$cadena.='<input type="checkbox" name="check_'.$ResJunio["Id"].'" id="check_'.$ResJunio["Id"].'" value="1"';			if($form["check_".$ResJunio["Id"]]==1 OR $form==$A){		$sumaconcepto=$sumaconcepto+$ResJunio["Cantidad"];$cadena.=' checked';}$cadena.='>'; 		$tjunio=$tjunio+$ResJunio["Cantidad"];}$cadena.='</td>';				
		$cadena.='<td id="jun_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolorjun.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResJunio["Cantidad"])){		$cadena.='<a href="#" class="Ntooltip" onclick="lightbox.style.visibility=\'visible\'; xajax_editar_gasto_jack(\''.$RResGastos["Id"].'\', \''.$ResJunio["Id"].'\', \''.$anno.'\')">$ '.number_format($ResJunio["Cantidad"],2).'<span>'.$ResJunio["Comentarios"].'</span></a>';}					$cadena.='</td>';
		$cadena.='<td id="julc_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolorjul.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResJulio["Cantidad"])){		$cadena.='<input type="checkbox" name="check_'.$ResJulio["Id"].'" id="check_'.$ResJulio["Id"].'" value="1"';			if($form["check_".$ResJulio["Id"]]==1 OR $form==$A){		$sumaconcepto=$sumaconcepto+$ResJulio["Cantidad"];$cadena.=' checked';}$cadena.='>'; 		$tjulio=$tjulio+$ResJulio["Cantidad"];}$cadena.='</td>';				
		$cadena.='<td id="jul_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolorjul.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResJulio["Cantidad"])){		$cadena.='<a href="#" class="Ntooltip" onclick="lightbox.style.visibility=\'visible\'; xajax_editar_gasto_jack(\''.$RResGastos["Id"].'\', \''.$ResJulio["Id"].'\', \''.$anno.'\')">$ '.number_format($ResJulio["Cantidad"],2).'<span>'.$ResJulio["Comentarios"].'</span></a>';}					$cadena.='</td>';
		$cadena.='<td id="agoc_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolorago.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResAgosto["Cantidad"])){		$cadena.='<input type="checkbox" name="check_'.$ResAgosto["Id"].'" id="check_'.$ResAgosto["Id"].'" value="1"';			if($form["check_".$ResAgosto["Id"]]==1 OR $form==$A){		$sumaconcepto=$sumaconcepto+$ResAgosto["Cantidad"];$cadena.=' checked';}$cadena.='>'; 		$tagosto=$tagosto+$ResAgosto["Cantidad"];}$cadena.='</td>';				
		$cadena.='<td id="ago_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolorago.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResAgosto["Cantidad"])){		$cadena.='<a href="#" class="Ntooltip" onclick="lightbox.style.visibility=\'visible\'; xajax_editar_gasto_jack(\''.$RResGastos["Id"].'\', \''.$ResAgosto["Id"].'\', \''.$anno.'\')">$ '.number_format($ResAgosto["Cantidad"],2).'<span>'.$ResAgosto["Comentarios"].'</span></a>';}				$cadena.='</td>';
		$cadena.='<td id="sepc_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolorsep.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResSeptiembre["Cantidad"])){	$cadena.='<input type="checkbox" name="check_'.$ResSeptiembre["Id"].'" id="check_'.$ResSeptiembre["Id"].'" value="1"';	if($form["check_".$ResSeptiembre["Id"]]==1 OR $form==$A){	$sumaconcepto=$sumaconcepto+$ResSeptiembre["Cantidad"];$cadena.=' checked';}$cadena.='>'; 	$tseptiembre=$tseptiembre+$ResSeptiembre["Cantidad"];}$cadena.='</td>';	
		$cadena.='<td id="sep_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolorsep.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResSeptiembre["Cantidad"])){	$cadena.='<a href="#" class="Ntooltip" onclick="lightbox.style.visibility=\'visible\'; xajax_editar_gasto_jack(\''.$RResGastos["Id"].'\', \''.$ResSeptiembre["Id"].'\', \''.$anno.'\')">$ '.number_format($ResSeptiembre["Cantidad"],2).'<span>'.$ResSeptiembre["Comentarios"].'</span></a>';}	$cadena.='</td>';	
		$cadena.='<td id="octc_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcoloroct.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResOctubre["Cantidad"])){		$cadena.='<input type="checkbox" name="check_'.$ResOctubre["Id"].'" id="check_'.$ResOctubre["Id"].'" value="1"';		if($form["check_".$ResOctubre["Id"]]==1 OR $form==$A){		$sumaconcepto=$sumaconcepto+$ResOctubre["Cantidad"];$cadena.=' checked';}$cadena.='>'; 		$toctubre=$toctubre+$ResOctubre["Cantidad"];}$cadena.='</td>';			
		...
		$cadena.='<td id="novc_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolornov.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResNoviembre["Cantidad"])){	$cadena.='<input type="checkbox" name="check_'.$ResNoviembre["Id"].'" id="check_'.$ResNoviembre["Id"].'" value="1"';	if($form["check_".$ResNoviembre["Id"]]==1 OR $form==$A){	$sumaconcepto=$sumaconcepto+$ResNoviembre["Cantidad"];$cadena.=' checked';}$cadena.='>'; 	$tnoviembre=$tnoviembre+$ResNoviembre["Cantidad"];}$cadena.='</td>';	
		$cadena.='<td id="nov_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolornov.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResNoviembre["Cantidad"])){	$cadena.='<a href="#" class="Ntooltip" onclick="lightbox.style.visibility=\'visible\'; xajax_editar_gasto_jack(\''.$RResGastos["Id"].'\', \''.$ResNoviembre["Id"].'\', \''.$anno.'\')">$ '.number_format($ResNoviembre["Cantidad"],2).'<span>'.$ResNoviembre["Comentarios"].'</span></a>';}		$cadena.='</td>';	
		$cadena.='<td id="dicc_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolordic.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResDiciembre["Cantidad"])){	$cadena.='<input type="checkbox" name="check_'.$ResDiciembre["Id"].'" id="check_'.$ResDiciembre["Id"].'" value="1"';	if($form["check_".$ResDiciembre["Id"]]==1 OR $form==$A){	$sumaconcepto=$sumaconcepto+$ResDiciembre["Cantidad"];$cadena.=' checked';}$cadena.='>'; 	$tdiciembre=$tdiciembre+$ResDiciembre["Cantidad"];}$cadena.='</td>';	
		$cadena.='<td id="dic_'.$A.'" onmouseover="row_'.$A.'.style.background=\'#00CED1\';con_'.$A.'.style.background=\'#00CED1\';ene_'.$A.'.style.background=\'#00CED1\';feb_'.$A.'.style.background=\'#00CED1\';mar_'.$A.'.style.background=\'#00CED1\';abr_'.$A.'.style.background=\'#00CED1\';may_'.$A.'.style.background=\'#00CED1\';jun_'.$A.'.style.background=\'#00CED1\';jul_'.$A.'.style.background=\'#00CED1\';ago_'.$A.'.style.background=\'#00CED1\';sep_'.$A.'.style.background=\'#00CED1\';oct_'.$A.'.style.background=\'#00CED1\';nov_'.$A.'.style.background=\'#00CED1\';dic_'.$A.'.style.background=\'#00CED1\';enec_'.$A.'.style.background=\'#00CED1\';febc_'.$A.'.style.background=\'#00CED1\';marc_'.$A.'.style.background=\'#00CED1\';abrc_'.$A.'.style.background=\'#00CED1\';mayc_'.$A.'.style.background=\'#00CED1\';junc_'.$A.'.style.background=\'#00CED1\';julc_'.$A.'.style.background=\'#00CED1\';agoc_'.$A.'.style.background=\'#00CED1\';sepc_'.$A.'.style.background=\'#00CED1\';octc_'.$A.'.style.background=\'#00CED1\';novc_'.$A.'.style.background=\'#00CED1\';dicc_'.$A.'.style.background=\'#00CED1\';tot_'.$A.'.style.background=\'#00CED1\';" onmouseout="row_'.$A.'.style.background=\'#CCCCCC\';con_'.$A.'.style.background=\'#CCCCCC\';ene_'.$A.'.style.background=\''.$bgcolorene.'\';feb_'.$A.'.style.background=\''.$bgcolorfeb.'\';mar_'.$A.'.style.background=\''.$bgcolormar.'\';abr_'.$A.'.style.background=\''.$bgcolorabr.'\';may_'.$A.'.style.background=\''.$bgcolormay.'\';jun_'.$A.'.style.background=\''.$bgcolorjun.'\';jul_'.$A.'.style.background=\''.$bgcolorjul.'\';ago_'.$A.'.style.background=\''.$bgcolorago.'\';sep_'.$A.'.style.background=\''.$bgcolorsep.'\';oct_'.$A.'.style.background=\''.$bgcoloroct.'\';nov_'.$A.'.style.background=\''.$bgcolornov.'\';dic_'.$A.'.style.background=\''.$bgcolordic.'\';enec_'.$A.'.style.background=\''.$bgcolorene.'\';febc_'.$A.'.style.background=\''.$bgcolorfeb.'\';marc_'.$A.'.style.background=\''.$bgcolormar.'\';abrc_'.$A.'.style.background=\''.$bgcolorabr.'\';mayc_'.$A.'.style.background=\''.$bgcolormay.'\';junc_'.$A.'.style.background=\''.$bgcolorjun.'\';julc_'.$A.'.style.background=\''.$bgcolorjul.'\';agoc_'.$A.'.style.background=\''.$bgcolorago.'\';sepc_'.$A.'.style.background=\''.$bgcolorsep.'\';octc_'.$A.'.style.background=\''.$bgcoloroct.'\';novc_'.$A.'.style.background=\''.$bgcolornov.'\';dicc_'.$A.'.style.background=\''.$bgcolordic.'\';tot_'.$A.'.style.background=\'#CCCCCC\';" bgcolor="'.$bgcolordic.'" align="right" class="texto" style="border:1px solid #FFFFFF">';if(isset($ResDiciembre["Cantidad"])){	$cadena.='<a href="#" class="Ntooltip" onclick="lightbox.style.visibility=\'visible\'; xajax_editar_gasto_jack(\''.$RResGastos["Id"].'\', \''.$ResDiciembre["Id"].'\', \''.$anno.'\')">$ '.number_format($ResDiciembre["Cantidad"],2).'<span>'.$ResDiciembre["Comentarios"].'</span></a>';}		$cadena.='</td>';
		
		$cadena.='<td id="tot_'.$A.'" bgcolor="#CCCCCC" align="right" class="texto" style="border:1px solid #FFFFFF">';if($sumaconcepto>0){$cadena.='$ '.number_format($sumaconcepto,2);}$cadena.='</td></tr>';	
	...
	$cadena.='<tr>
			...
			<tr>
				<td colspan="2" bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF"><a href="#" style="color:#FFFFFF" class="total" onclick="xajax_gastos_jack(\'checkallt\', \'\', \''.$anno.'\')">Total: </a></td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF"><input type="checkbox" name="tenero" id="tenero" value="1"'; if($accion=='checkallt' OR $form["tenero"]==1){$ttotal=$ttotal+$tenero; $cadena.=' checked';}$cadena.='></td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF">$ '.number_format($tenero,2).'</td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF"><input type="checkbox" name="tfebrero" id="tfebrero" value="1"'; if($accion=='checkallt' OR $form["tfebrero"]==1){$ttotal=$ttotal+$tfebrero; $cadena.=' checked';}$cadena.='></td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF">$ '.number_format($tfebrero,2).'</td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF"><input type="checkbox" name="tmarzo" id="tmarzo" value="1"'; if($accion=='checkallt' OR $form["tmarzo"]==1){$ttotal=$ttotal+$tmarzo; $cadena.=' checked';}$cadena.='></td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF">$ '.number_format($tmarzo,2).'</td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF"><input type="checkbox" name="tabril" id="tabril" value="1"'; if($accion=='checkallt' OR $form["tabril"]==1){$ttotal=$ttotal+$tabril; $cadena.=' checked';}$cadena.='></td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF">$ '.number_format($tabril,2).'</td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF"><input type="checkbox" name="tmayo" id="tmayo" value="1"'; if($accion=='checkallt' OR $form["tmayo"]==1){$ttotal=$ttotal+$tmayo; $cadena.=' checked';}$cadena.='></td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF">$ '.number_format($tmayo,2).'</td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF"><input type="checkbox" name="tjunio" id="tjunio" value="1"'; if($accion=='checkallt' OR $form["tjunio"]==1){$ttotal=$ttotal+$tjunio; $cadena.=' checked';}$cadena.='></td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF">$ '.number_format($tjunio,2).'</td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF"><input type="checkbox" name="tjulio" id="tjulio" value="1"'; if($accion=='checkallt' OR $form["tjulio"]==1){$ttotal=$ttotal+$tjulio; $cadena.=' checked';}$cadena.='></td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF">$ '.number_format($tjulio,2).'</td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF"><input type="checkbox" name="tagosto" id="tagosto" value="1"'; if($accion=='checkallt' OR $form["tagosto"]==1){$ttotal=$ttotal+$tagosto; $cadena.=' checked';}$cadena.='></td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF">$ '.number_format($tagosto,2).'</td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF"><input type="checkbox" name="tseptiembre" id="tseptiembre" value="1"'; if($accion=='checkallt' OR $form["tseptiembre"]==1){$ttotal=$ttotal+$tseptiembre; $cadena.=' checked';}$cadena.='></td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF">$ '.number_format($tseptiembre,2).'</td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF"><input type="checkbox" name="toctubre" id="toctubre" value="1"'; if($accion=='checkallt' OR $form["toctubre"]==1){$ttotal=$ttotal+$toctubre; $cadena.=' checked';}$cadena.='></td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF">$ '.number_format($toctubre,2).'</td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF"><input type="checkbox" name="tnoviembre" id="tnoviembre" value="1"'; if($accion=='checkallt' OR $form["tnoviembre"]==1){$ttotal=$ttotal+$tnoviembre; $cadena.=' checked';}$cadena.='></td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF">$ '.number_format($tnoviembre,2).'</td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF"><input type="checkbox" name="tdiciembre" id="tdiciembre" value="1"'; if($accion=='checkallt' OR $form["tdiciembre"]==1){$ttotal=$ttotal+$tdiciembre; $cadena.=' checked';}$cadena.='></td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF">$ '.number_format($tdiciembre,2).'</td>
				<td bgcolor="#5263ab" align="right" class="texto3" style="border:1px solid #FFFFFF">';if($ttotal>0){$cadena.='$ '.number_format($ttotal,2);}$cadena.='</td>
			</tr>
			</table></form>';
...
function agregar_gasto_jack()
{
	$cadena='<form name="fadgastojack" id="fadgastojack">
			<table style="border:1px solid #FFFFFF" cellpadding="3" cellspacing="0" align="center">
				...
				<tr>
					<th colspan="2" bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">Agregar Gasto Jack</th>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="texto" align="left" bgcolor="#CCCCCC" style="border:1px solid #FFFFFF"><select name="dia" id="dia"><option value="00">Día</option>';
	for($i=1; $i<=31; $i++)
	{
		if($i<=9){$i='0'.$i;}
...
function editar_gasto_jack($gasto, $monto=NULL, $anno)
{
	include ("conexion.php");
	...
	$cadena='<form name="feditgastojack" id="feditgastojack">
			<table style="border:1px solid #FFFFFF" cellpadding="3" cellspacing="0" align="center">
				<tr>
					<td colspan="2" align="right" class="texto">[ <a href="#" onclick="lightbox.style.visibility=\'hidden\';">X</a> ]</td>
				</tr>
				<tr>
					<th colspan="2" bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">Editar Gasto Jack</th>
				</tr>
				<tr>
					<td class="texto" align="right" bgcolor="#CCCCCC" style="border:1px solid #FFFFFF">Concepto: </td>
	...
	{
		if($i<=9){$i='0'.$i;}
		$cadena.='<option value="'.$i.'"';if($i==$ResMonto["Fecha"][8].$ResMonto["Fecha"][9]){$cadena.=' selected';}$cadena.='>'.$i.'</option>';
	}
	$cadena.='			</select> <select name="mes" id="mes">
							<option value="00">Mes</option>
	...
	$cadena.='			</select></td>
				...
				<tr>
					<td class="texto" align="right" bgcolor="#CCCCCC" style="border:1px solid #FFFFFF">Check: </td>
					<td class="texto" align="left" bgcolor="#CCCCCC" style="border:1px solid #FFFFFF"><input type="checkbox" name="checka" id="checka" value="1"';if($ResMonto["checka"]==1){$cadena.=' checked';}$cadena.='></td>
				</tr>
				<tr>
					<td class="texto" align="right" bgcolor="#CCCCCC" style="border:1px solid #FFFFFF">Estado: </td>
				...
				<tr>
					<td class="texto" align="center" colspan="2" bgcolor="#CCCCCC" style="border:1px solid #FFFFFF">
						...
						<input type="button" name="boteditgastojack" id="boteditgastojack" value="Editar>>" class="boton" onclick="lightbox.style.visibility=\'hidden\';  xajax_gastos_jack(\'editgastojack\', xajax.getFormValues(\'feditgastojack\'), \''.$anno.'\'); document.getElementById(\'lightbox\').innerHTML = \'\'">
					</td>
				</tr>
			</table>
			</form>';
...
function editar_gasto_jack_nuevo_monto($gasto, $anno)
{
	include ("conexion.php");
	...
	$cadena.='			</select></td>
				...
				<tr>
					<td class="texto" align="center" colspan="2" bgcolor="#CCCCCC" style="border:1px solid #FFFFFF">
						<input type="hidden" name="idgasto" id="idgasto" value="'.$ResGasto["Id"].'">
						<input type="button" name="boteditgastojack" id="boteditgastojack" value="Editar>>" class="boton" onclick="lightbox.style.visibility=\'hidden\';  xajax_gastos_jack(\'editgastojacknuevomonto\', xajax.getFormValues(\'feditgastojack\'), \''.$anno.'\'); document.getElementById(\'lightbox\').innerHTML = \'\'">
					</td>
				</tr>
			</table>
			</form>';
