...
function pagos($cliente=NULL, $accion=NULL, $form=NULL, $anno='todos', $annohist='todos')
{
    ...
    <select name="anno" id="anno" onChange="xajax_pagos(\''.$cliente.'\', \''.$accion.'\', \''.$form.'\', this.value, document.getElementById(\'annohist\').value)">
    ...
    */
	...
	$cadena.='	</select> A&ntilde;o: Historico:  
    
    
    <select name="annohist" id="annohist" onChange="xajax_pagos(\''.$cliente.'\', \''.$accion.'\', \''.$form.'\', this.value, document.getElementById(\'annohist\').value)">
...
function pagos_provedor($provedor=NULL, $accion=NULL, $form=NULL, $anno='todos', $annohist='todos')
{
  ...
  /*
    ...
    $cadena.='
    <select name="anno" id="anno" onChange="xajax_pagos_provedor(\''.$provedor.'\', \''.$accion.'\', \''.$form.'\', this.value, document.getElementById(\'annohist\').value)">
	...
	{
                                         //if($anno==$i)
                                         //if($i == (date("Y"))){$cadena.=' selected';}
		$cadena.='<option value="'.$i.'"';$cadena.='>'.$i.'</option>';
	}	
    ...
    */
    ...
    A&ntilde;o Historico: 
    <select name="annohist" id="annohist" onChange="xajax_pagos_provedor(\''.$provedor.'\', \''.$accion.'\', \''.$form.'\', this.value, document.getElementById(\'annohist\').value)">
    
					<option value="todos">Todos</option>';
	for($i=2000; $i<=(date("Y")+10); $i++)
	{
                                     //$annohist==$i -- if($i == (date("Y"))){$cadena.=' selected';}
        $cadena.='<option value="'.$i.'"';if($annohist==$i){$cadena.=' selected';}$cadena.='>'.$i.'</option>';                             
		//$cadena.='<option value="'.$i.'"';$cadena.='>'.$i.'</option>';
	}	
	$cadena.='	</select>';
	...
	//else
	//{
		$ResCompras=mysql_query("SELECT * FROM compras WHERE Provedor='".$provedor."' AND Historico='1' ".$ah." ORDER BY Fecha ASC");
	//}
	...
	//else
	//{
		$ResPagos=mysql_query("SELECT * FROM pagos_prov WHERE Provedor='".$provedor."' AND Historico='1'  ".$ah."  ORDER BY Fecha ASC");
	//}
	$pago=0;
	while($RResPagos=mysql_fetch_array($ResPagos))
	{
