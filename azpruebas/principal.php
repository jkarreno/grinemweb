...
$xajax = new xajax(); 
	...
	$xajax->registerFunction("cobranza");
	//provedores
	...
	$xajax->registerFunction("historico_provedor");
	//pagos
	...
	$xajax->registerFunction("juridico_provedor");
	...
	$xajax->registerFunction("agregar_agente");
...
<div id="top" style="width:100%; height: 81px; background-color: #37589f; top: 0px;  position: fixed; z-index:999;"><div id="logo" style="position: absolute; left:10px; top:5px;"><img src="images/AC.jpg" border="0"></div>

<div id="bienvenida" style="position: absolute; width: 100%; left:0px; padding: 0 20 0 0px;">
    
    <p align="right" class="texto2">
    
    <?php echo utf8_encode($_SESSION["nombreuser"]);?> (PRUEBAS)
...
<div id="cuadro" style="width:100%; background-color: #FFFFFF; border: 1px solid #008001; position: absolute; top: 40px; left:0px;">
	<div id="menutop" style="width:100%; height: 40px; background-color: #a19aaa; position: fixed; top: 40px; padding: 0 10 5 10px; z-index:1000;">
		<ul>
				<li><a href="principal.php"><img src="images/home.png" border="0" width="80%"></a></li>
				<li><a href="#" onclick="xajax_clientes()">Clientes</a>
					<?php if($_SESSION["perfil"]!='AgenteV' AND $_SESSION["perfil"]!='produccion')
					{
						echo '<ul>
				...
				<?php if($_SESSION["perfil"]!='AgenteV' AND $_SESSION["perfil"]!='produccion')
					{
						echo '<li><a href="#" onclick="xajax_provedores()">Proveedores</a>
					<ul>
						<li><a href="#" onclick="xajax_agregar_provedor()">Agregar Proveedor</a></li>
					</ul>
				</li>
				<li><a href="#" onclick="xajax_ver_juridico()">Juridico</a>
					
				</li>
				<li><a href="#" onclick="xajax_bancos()">Bancos</a>
					<ul>
						<li><a href="#" onclick="xajax_agregar_cuenta()">Agregar Cuenta</a></li>
					</ul>
				</li>
				<li><a href="#" onclick="xajax_telas()">Telas</a>
					<ul>
					</ul>
				</li>
				...
				<li><a href="#" onclick="xajax_gastos_azul(\'\',\'\',\''.date("Y").'\')">Gastos Azul</a>
					<ul>
					</ul>
				</li><li><a href="#" onclick="xajax_gastos_jack(\'\',\'\',\''.date("Y").'\')">Gastos Jack</a>
					<ul>
					</ul>
				</li>
				<li><a href="#" onclick="xajax_metros()">Metros</a>
				<li><a href="historico/principal.php" target="_blank">Historico</a>
					<ul>
					</ul>
				</li>
				<li><a href="#" onclick="xajax_agentes()">Agentes</a>
					<ul>
						<li><a href="#" onclick="xajax_agregar_agente()">Agregar Agente</a></li>
					</ul>
				</li>';
					}
				?>
				
				<?php if($_SESSION["perfil"]=='administra')
					{
						echo '<li><a href="respaldo_base.php">Respaldar</a>';
					}
				?>
	...
	<div id="lightbox" style="position: absolute; top:70px; left:100px; width:1500px; padding: 10 10 10 10px; z-index:100; visibility:hidden"></div>
