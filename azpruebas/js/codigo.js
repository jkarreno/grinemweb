...
//seleccionar todo suma compras proveedores
function seleccionar_todo_sumacomprasp(){ 
if(document.getElementById("allsumacomprasp").checked==true){ // selecciona todos con visto
       for (i=0;i<document.fsumacomprasp.elements.length;i++) 
          if(document.fsumacomprasp.elements[i].type == "checkbox") 
             document.fsumacomprasp.elements[i].checked=1; 
   }else{ // deselecciona todos
        for (i=0;i<document.fsumacomprasp.elements.length;i++) 
          if(document.fsumacomprasp.elements[i].type == "checkbox") 
             document.fsumacomprasp.elements[i].checked=0
   }
}
