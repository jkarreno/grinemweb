...
function cobranza($accion=NULL, $form=NULL, $vendedor='todos')
{
	...
	if($_SESSION["perfil"]!='AgenteV'){$ResClientesA=mysql_query("SELECT Id, Nombre, Adeudo, Vencido, DeudaVencidaFROM clientes WHERE Juridico='0' AND Tipo='A' ORDER BY DeudaVencida DESC");}
	...
	$cadena.='			<form name="fsumaaexistencias" id="fsumaaexistencias">
							<table border="0" style="border:1px solid #FFFFFF" cellpadding="3" cellspacing="0" align="center">
								...
								<tr>
									<td colspan="5" bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">EXISTENCIA MODELOS</td>
								</tr>
								<tr>
