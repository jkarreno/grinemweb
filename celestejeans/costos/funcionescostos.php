...
function costos()
{
	...
	$cadena='<table border="0" style="border:1px solid #FFFFFF" cellpadding="3" cellspacing="0" align="center">
				<tr>
					<td colspan="11" align="right" class="texto">| <a href="#" onclick="xajax_agregar_costo()">Agregar Costo</a> |</td>
				</tr>
				<tr>
	...
	$cadena='<form name="fadcosto" id="fadcosto">
			...
			<table style="border:1px solid #FFFFFF" cellpadding="3" cellspacing="0" align="center">
				...
				<tr>
					...
					<td class="texto" align="right" bgcolor="#CCCCCC" style="border:1px solid #FFFFFF"><input type="text" name="cu_bordado" id="cu_bordado" class="input" onkeyup="costos(this.value, c_bordad.value, t_bordado); costo_prenda(parseFloat(t_costotela.value), parseFloat(t_disenomolde.value), parseFloat(t_maquila.value), parseFloat(t_boton.value), parseFloat(t_remaches.value), parseFloat(t_cierre.value), parseFloat(t_bordado.value), parseFloat(t_cinturon.value), parseFloat(t_etiqintbor.value), parseFloat(t_placa.value), parseFloat(t_etiqtallainterna.value), parseFloat(t_etiqadherible.value), parseFloat(t_etiqtallaexterna.value), parseFloat(t_etiqcolgante.value), parseFloat(t_etiqmonarch.value), parseFloat(t_etiquetapielexterna.value), parseFloat(t_lavado.value), parseFloat(t_transfer.value), parseFloat(t_terminado.value), parseFloat(t_transporte.value), parseFloat(t_comisionvendedor.value), parseFloat(t_utilidadgabriel.value), costoporprenda); costo_utilidad(parseFloat(costoporprenda.value), parseFloat(precioventa.value), utilidad); costo_utilidad_real(utilidad.value, tprendas.value, utilidadreal)"></td>
...
function editar_costo($costo, $campo=NULL, $fcampo=NULL, $fcomen=NULL, $fpcomen=NULL)
{
	...
	$cadena.='	<tr>
					<td class="texto" align="right" bgcolor="'.$bgcolor_UtilidadGabriel.'" style="border:1px solid #FFFFFF"><a href="#" class="Ntooltip" onclick="document.getElementById(\'lightbox\').innerHTML = \'\'; lightbox.style.visibility=\'visible\';xajax_costos_check(\''.$ResCosto["Id"].'\', \'UtilidadGabriel\')">Utilidad Gabriel: <span>'.$ResCosto["Comen_UtilidadGabriel"].'</span></a> </td>
