...
$xajax = new xajax(); 
	...
	$xajax->registerFunction("eliminar_tela");
	//gastos
	...
	$xajax->registerFunction("eliminar_avio");
	//agentes
...
<div id="cuadro" style="width:100%; background-color: #FFFFFF; border: 1px solid #008001; position: absolute; top: 40px; left:0px;">
	<div id="menutop" style="width:100%; height: 40px; background-color: #a19aaa; position: fixed; top: 40px; padding: 0 10 5 10px; z-index:1000;">
		<ul>
				...
				<li><a href="#" onclick="xajax_gastos_azul(\'\',\'\',\''.date("Y").'\')">Gastos Celeste</a>
					<ul>
					</ul>
				</li>
	...
	<div id="lightbox" style="position: absolute; top:70px; left:100px; width:1400px; padding: 10 10 10 10px; z-index:100; visibility:hidden"></div>
