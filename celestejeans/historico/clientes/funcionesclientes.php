...
function clientes()
{
	...
	$ResClientes=mysql_query("SELECT * FROM clientes WHERE Juridico='2' ORDER BY Nombre ASC");
	...
	{	
		...
		$cadena.='<tr id="row_'.$A.'" style="background: '.$bgcolor.'">
					...
					<td align="left" class="texto" style="border:1px solid #FFFFFF" onmouseover="row_'.$A.'.style.background=\'#00CED1\'" onmouseout="row_'.$A.'.style.background=\''.$bgcolor.'\'">'.$RResClientes["Vendedor"].'</td>
					<td align="left" class="texto" style="border:1px solid #FFFFFF" onmouseover="row_'.$A.'.style.background=\'#00CED1\'" onmouseout="row_'.$A.'.style.background=\''.$bgcolor.'\'"><a href="#" onclick="xajax_editar_cliente(\''.$RResClientes["Id"].'\')"><img src="images/edit.png" border="0"></a></td>
				</tr>';
		$A++; $I++;
	...
	$cadena='<form name="fadcliente" id="fadcliente">
			<table style="border:1px solid #FFFFFF" cellpadding="3" cellspacing="0" align="center">
				...
				<tr>
					...
					<td class="texto" align="left" bgcolor="#CCCCCC" style="border:1px solid #FFFFFF"><input type="text" name="vendedor" id="vendedor" class="input" size="100"></td>
				</tr>
				<tr>
...
function agregar_cliente_2($cliente)
{
	...
	mysql_query("INSERT INTO clientes (Nombre, NombreDueno, Marcas, Direccion, CP, Poblacion, RFC, Telefono, Celular, CelNextel, IdNextel, CorreoE, PaginaWeb, Vendedor, PanCaballero, PanDama, CamHombre, BluDama, TejCircular, Credito, Tipo, Zona, DireccionEntrega, Transporte, PlazoOtorgado, Calificacion, EncargadoCompras, CorreoCompras, EncargadoPagos, CorreoPagos, HistorialCliente, ReferenciasComerciales, GabardinaRigida, GabardinaSTR, MezclillaRigida, MezclillaSTR) 
...
function editar_cliente($cliente)
{
	...
	$cadena='<form name="feditcliente" id="feditcliente">
			<table style="border:1px solid #FFFFFF" cellpadding="3" cellspacing="0" align="center">
				...
				<tr>
					<td class="texto" align="right" bgcolor="#CCCCCC" style="border:1px solid #FFFFFF">Vendedor: </td>
					<td class="texto" align="left" bgcolor="#CCCCCC" style="border:1px solid #FFFFFF"><input type="text" name="vendedor" id="vendedor" class="input" size="50" value="'.$ResCliente["Vendedor"].'"></td>
				</tr>
				<tr>
