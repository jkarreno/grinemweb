...
function metros($accion=NULL, $form=NULL)
{
	...
	if($accion!=NULL)
	{
		switch($accion)
		{
			...
			case 'sumacompras':
				$sumacompras=0;
				$ResSuma=mysql_query("SELECT Id, Metros FROM compras WHERE HistoricoMetros='1' AND Metros!='0.00' ORDER BY Id ASC");
			...
			case 'sumaventas':
				$sumaventas=0;
				$ResSumaV=mysql_query("SELECT Id, Metros FROM ventas WHERE HistoricoMetros='1' AND Metros!='0.00' ORDER BY Id ASC");
	...
	$ResCompras=mysql_query("SELECT Id, Provedor, Fecha, Comentarios, Metros, checkaMetros FROM compras WHERE HistoricoMetros='1' AND Metros!='0.00' ORDER BY Fecha ASC");
	$bgcolor='#CCC'; $A=1;
	...
	$ResVentas=mysql_query("SELECT Id, Cliente, Fecha, Comentarios, Metros, checkaMetros FROM ventas WHERE HistoricoMetros='1' AND Metros!='0.00' ORDER BY Fecha ASC");
	$bgcolor='#CCC'; $A=1;
