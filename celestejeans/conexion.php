...
$conn=mysql_connect ("localhost", "celestejeans_web", "celestejeans16#") or die('Cannot connect to the database because: ' . mysql_error());
mysql_select_db ("celestejeans_web");
