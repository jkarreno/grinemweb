...
$pdf->SetY(16);
$pdf->SetX(8);
$pdf->Cell(120,4,'REPORTE DE COMPRAS',0,0,'L',1);
//fecha
$pdf->SetFillColor(255,255,255);
$pdf->SetFont('Arial','B',10);
$pdf->SetTextColor(000,000,000);
...
$pdf->cell(100,4,'Provedor',1,0,'C',1);
$pdf->Cell(20,4,'Num. Orden Compra',1,0,'C',1);
...
while($RResFacturas=mysql_fetch_array($ResFacturas))
{
	...
	$pdf->Cell(20,4,$RResFacturas["NumFactura"],1,0,'C',0);
