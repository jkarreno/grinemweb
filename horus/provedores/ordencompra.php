...
if($_POST["numorden"]){$numorden=$_POST["numorden"];}
elseif($_GET["numorden"]){$numorden=$_GET["numorden"];}

//datos de la orden
$ResOrden=mysql_fetch_array(mysql_query("SELECT * FROM ordenescompraprovedores WHERE NumOrden='".$numorden."' AND Empresa='".$_SESSION["empresa"]."' AND Sucursal='".$_SESSION["sucursal"]."' LIMIT 1"));
...
$ResProvedor=mysql_fetch_array(mysql_query("SELECT * FROM provedores WHERE Id='".$ResOrden["Provedor"]."' LIMIT 1"));
...
$pdf->SetY(14);
$pdf->SetX(135);
$pdf->Cell(120,4,'Orde de Compra Num.: '.$ResOrden["NumOrden"],0,0,'L',1);
//fecha
$pdf->SetFillColor(255,255,255);
$pdf->SetFont('Arial','B',10);
$pdf->SetTextColor(000,000,000);
$pdf->SetY(18);
$pdf->SetX(135);
$pdf->Cell(120,4,'Fecha: '.$ResOrden["FechaOrden"],0,0,'L',1);
//separador
...
$pdf->SetY(44);
$pdf->SetX(25);
$pdf->Cell(8,4,$ResProvedor["Nombre"],0,0,'L',1);
//RFC
$pdf->SetFillColor(255,255,255);
$pdf->SetFont('Arial','',10);
$pdf->SetTextColor(000,000,000);
$pdf->SetY(48);
$pdf->SetX(25);
$pdf->Cell(8,4,$ResProvedor["RFC"],0,0,'L',1);
//domicilio y colonia
$pdf->SetFillColor(255,255,255);
$pdf->SetFont('Arial','',10);
$pdf->SetTextColor(000,000,000);
$pdf->SetY(52);
$pdf->SetX(25);
$pdf->Cell(8,4,$ResProvedor["Direccion"].' Col. '.$ResProvedor["Colonia"],0,0,'L',1);
//ciudad y estado
$pdf->SetFillColor(255,255,255);
$pdf->SetFont('Arial','',10);
$pdf->SetTextColor(000,000,000);
$pdf->SetY(56);
$pdf->SetX(25);
$pdf->Cell(8,4,$ResProvedor["Ciudad"].' '.$ResProvedor["Estado"],0,0,'L',1);
...
$pdf->SetY(60);
$pdf->SetX(25);
$pdf->Cell(8,4,'C. P.: '.$ResProvedor["CP"],0,0,'L',1);
/*Numero de Provedor
$pdf->SetFillColor(255,255,255);
$pdf->SetFont('Arial','',10);
$pdf->SetTextColor(000,000,000);
...
$pdf->SetY(64);
$pdf->SetX(80);
$pdf->Cell(10,4,'Pedido Num.: '.$ResOrden["NumPedido"],0,0,'L',1);
//separador*/
...
$pdf->SetY(70);
$pdf->SetX(8);
$pdf->Cell(195,4,'Observaciones: '.$ResOrden["Observaciones"],0,0,'L',1);
//Agente
$pdf->SetFillColor(255,255,255);
$pdf->SetFont('Arial','',10);
$pdf->SetTextColor(000,000,000);
$pdf->SetY(74);
$pdf->SetX(8);
$pdf->Cell(195,4,'Comprador: '.$ResOrden["Comprador"],0,0,'L',1);
//posicion inicial y por pagina
...
$ResPartidas=mysql_query("SELECT * FROM ordencompraprov WHERE NumOrden='".$numorden."' AND Empresa='".$_SESSION["empresa"]."' AND Sucursal='".$_SESSION["sucursal"]."' ORDER BY Id ASC");
$partidas=1;
while($RResPartidas=mysql_fetch_array($ResPartidas))
{
    ...
    $pdf->Cell(20,4,'$ '.number_format($RResPartidas["Costo"], 2),0,0,'R',1);
...
$pdf->Cell(100,4,strtoupper(num2letras($numero[0]).' pesos '.$numero[1][0].$numero[1][1].'/100 M. N.'),0,0,'L',1);
//despliega Iva
$pdf->SetFillColor(255,255,255);
$pdf->SetFont('Arial','B',8);
$pdf->SetTextColor(000,000,000);
