...
$ResMovimientos=mysql_query("SELECT * FROM movinventario WHERE Producto LIKE '".$producto."' AND Ajuste='TA' AND Almacen LIKE '".$_SESSION["empresa"]."_".$_SESSION["sucursal"]."%' ORDER BY Id ASC, Fecha ASC");
...
if($j==51)
	...
	$pdf->Cell(20,4,$almacen[2],1,0,'C',1);
	$pdf->Cell(100,4,$ResProducto["Clave"].' - '.$ResProducto["Nombre"],1,0,'C',1);
