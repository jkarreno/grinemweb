...
//producto
$ResProducto=mysql_fetch_array(mysql_query("SELECT Clave, Nombre FROM productos WHERE Id='".$producto."' LIMIT 1"));
...
$pdf->SetY(16);
$pdf->SetX(8);
$pdf->Cell(120,4,'REPORTE DE MOVIMIENTOS DE INVENTARIO',0,0,'L',1);
//Producto
...
$pdf->SetY(20);
$pdf->SetX(8);
$pdf->Cell(120,4,'Producto: '.$ResProducto["Clave"].' - '.$ResProducto["Nombre"],0,0,'L',1);
...
if($j==51)
	{
		...
		$pdf->SetY(270);
		$pdf->SetX(8);
		$pdf->MultiCell(175,4,'II-Inventario Inicial. TA-Traslado Almacen. DM-Devolución de Mercancía. CM-Cambio por otra Mercancía. OP-Obsequio de Provedor. CD-Compra Directa. FL-Factura Libre. OC-Obsequio de Cliente. P-Promoción. M-Merma.',1,1,'L',1);
