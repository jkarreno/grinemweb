...
$ResPartidasFactura=mysql_fetch_array(mysql_query("SELECT Descripcion FROM parametros WHERE Empresa='".$_SESSION["empresa"]."' AND PerteneceA='ConfigFacturas' AND Nombre='Partidas' LIMIT 1"));
