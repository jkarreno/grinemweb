...
<center><div id="central"><div id="bienvenida"><span class="busqueda"><?php echo $mensajebienvenida; ?></span></div>
	<div id="header">
		...
		<div id="tipo"><a href="#" onmouseover="mostrar('tipocambio')"><img src="images/tipocambio.png" border="0" onmouseover="mostrar('tipocambio')" onmouseout="ocultar('tipocambio')"></a><img src="images/barrita.png" boder="0"><a href="#" onclick="xajax_quejas()"><img src="images/quejas.png" border="0"></a></div>
		...
		<div id="botoncontacto" align="center" onmouseover="ocultar('menumarcas')"><a href="index2.php?contenido=contacto"><br />Contacto</a></div>
	</div>
