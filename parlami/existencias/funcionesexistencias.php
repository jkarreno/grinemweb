...
function telas()
{
	...
	$cadena='<table style="border:1px solid #FFFFFF" cellpadding="3" cellspacing="0" align="center">
				<tr>
					<td colspan="12" bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">| <a href="#" onclick="xajax_agregar_tela()">Agregar Modelo</a> |</td>
				</tr>
				<tr>
...
function editar_tela($tela)
{
	...
	if($_SESSION["perfil"]=='asistente' AND $ResTela["CheckTela"]==0){$cadena.='<input type="button" name="botedittela" id="botedittela" value="Editar>>" class="boton" onclick="xajax_editar_tela_2(xajax.getFormValues(\'fedittela\'))">';}
	if($_SESSION["perfil"]=='administra'){$cadena.='<input type="button" name="botedittela" id="botedittela" value="Editar>>" class="boton" onclick="xajax_editar_tela_2(xajax.getFormValues(\'fedittela\'))">';}
	$cadena.='		</td>
				</tr>
			</table>
			</form>';
...
function existencias_avios($avio, $accion=NULL, $form=NULL)
{
	...
	$cadena.='<table style="border:1px solid #FFFFFF" cellpadding="3" cellspacing="0" align="center">
				<tr>
					<td colspan="12" bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">Avios</td>
				</tr>
				<tr>
					<td bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">Nombre</td>
					<td bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">Color</td>
					...
					<form name="fsumaventas" id="fsumaventas">
						<table border="0" style="border:1px solid #FFFFFF" cellpadding="3" cellspacing="0" align="center">
							<tr>
								...
								<td bgcolor="#FFFFFF" align="right" class="texto">';if($sumalasventas!=0){$cadena.=$sumalasventas;}$cadena.='</td>
							</tr>
							<tr>
