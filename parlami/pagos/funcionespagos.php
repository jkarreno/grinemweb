...
function pagos($cliente=NULL, $accion=NULL, $form=NULL, $anno='todos')
{
	...
	$cadena.='<td valign="top" class="texto">';
	...
	{		  
			$cadena.='<td valign="top" class="texto">
						Modelos: <select name="telas" id="telas" onchange="xajax_existencias(this.value)"><option>SELECCIONE</option>';
		...
		$cadena.='</select>  <img src="images/impresora.jpg" border="0"></td>';
	}
	$cadena.='		</tr>
					<tr>
						<td valign="top">';
...
if($_SESSION["perfil"]!='AgenteV' AND $_SESSION["perfil"]!='produccion')
{
	...
	$cadena.='</select><img src="images/impresora.jpg" border="0">
					...
					<tr>
						<td colspan="6" bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">EXISTENCIA PANTALONES</td>
					</tr>
					<tr>
						...
						<td bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">#</td>
						<td bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">PANTALON</td>
	...
	$cadena='<form name="feditcompra" id="feditcompra" method="post" action="javascript:void(null)">
			<table border="0" style="border:1px solid #FFFFFF" cellpadding="3" cellspacing="0" align="center">
				...
				<tr>
					...
					<td bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">CHECK</td>
					<td bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">HISTORICO</td>
					<td bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">PANTALONES 1</td>
				</tr>
				<tr>
					<td bgcolor="#CCCCCC" align="center" class="texto" style="border:1px solid #FFFFFF"><select name="dia" id="dia">';
	for($i=1;$i<=31;$i++)
...
function ver_historico($cliente=NULL, $accion=NULL, $form=NULL)
{
	...
	$cadena.='</select> <img src="images/impresora.jpg" border="0"> Pantalones: <select name="telas" id="telas" onchange="xajax_existencias(this.value)"><option>SELECCIONE</option>';
...
//////// PANTALLA HOME /////////
		...
		$cadena.='<form name="fsumaatelas" id="fsumaatelas"><table border="0" style="border:1px solid #FFFFFF" cellpadding="3" cellspacing="0" align="center">
					...
					<tr>
						<td colspan="6" bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">HISTORICO PANTALONES</td>
					</tr>
					<tr>
						<td bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF"><input type="checkbox" name="allatelas" id="allatelas" value="1" ';if($form["allatelas"]==1){$cadena.=' checked';}$cadena.=' onchange="seleccionar_todo_sumaatelas()"></td>
						<td bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">#</td>
