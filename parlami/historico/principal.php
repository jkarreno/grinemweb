...
<div id="top" style="width:100%; height: 81px; background-color: #000; top: 0px;  position: fixed; z-index:999;"><div id="logo" style="position: absolute; left:10px; top:5px; font-family: Arial; font-weight: bold; color:#FFF;"><img src="images/AC.jpg" border="0"></div>
...
<div id="cuadro" style="width:100%; background-color: #FFFFFF; border: 1px solid #008001; position: absolute; top: 40px; left:0px;">
	<div id="menutop" style="width:100%; height: 40px; background-color: #ffb6c1; position: fixed; top: 40px; padding: 0 10 5 10px; z-index:1000;">
		<ul>
				...
				<li><a href="#" onclick="xajax_gastos_azul('','','<?php echo (date("Y")-1);?>')">Gastos Parlimi</a>
					<ul>
					</ul>
				</li>
