...
function telas()
{
	...
	$cadena='<table style="border:1px solid #FFFFFF" cellpadding="3" cellspacing="0" align="center">
				<tr>
					<td colspan="11" bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">| <a href="#" onclick="xajax_agregar_tela()">Agregar Modelo</a> |</td>
				</tr>
				<tr>
					<td colspan="11" bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">Pantalones</td>
				</tr>
				<tr>
	...
	$ResTelas=mysql_query("SELECT * FROM telas WHERE Status='2' ORDER BY Nombre ASC");
...
function agregar_tela()
{
	...
	$cadena='<form name="fadtela" id="fadtela">
			<table style="border:1px solid #FFFFFF" cellpadding="3" cellspacing="0" align="center">
				...
				<tr>
					<td class="texto" align="right" bgcolor="#CCCCCC" style="border:1px solid #FFFFFF">Modelo Pantalon: </td>
...
function agregar_tela_2($form)
{
	...
	$cadena='<p align="center" class="textomensaje">Se agrego el modelo satisfactoriamente</p>';
...
function existencias($tela, $accion=NULL, $form=NULL)
{
	...
	$cadena.='<table style="border:1px solid #FFFFFF" cellpadding="3" cellspacing="0" align="center">
				<tr>
					<td colspan="12" bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">Pantalones</td>
				</tr>
				<tr>
					<td bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">Nombre</td>
					<td bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">Color</td>
	...
	$ResCompras=mysql_query("SELECT * FROM existencias WHERE Tela='".$tela."' AND (Tipo='Compra' OR Tipo='Devolucion') ORDER BY Fecha ASC");
	$A=1; $tcompras=0; $ccompras=0; $saldocompras=0;
	while($RResCompras=mysql_fetch_array($ResCompras))
	{
	if($ResTela["Status"]==2 OR $RResCompras["Historico"]==1)
	{
	...
	$ResVentas=mysql_query("SELECT * FROM existencias WHERE Tela='".$tela."' AND (Tipo='Venta' OR Tipo='Varios' OR Tipo='Proveedor') ORDER BY Fecha ASC");
	$A=1; $tventas=0; $cventas=0; $saldoventas=0;
	while($RResVentas=mysql_fetch_array($ResVentas))
	{
	if($ResTela["Status"]==2 OR $RResVentas["Historico"]==1)
	{
...
function editar_venta_tela($venta, $tela)
{
	...
	$cadena.='			</select>				
				...
				<tr>
					<td class="texto" align="right" bgcolor="#CCCCCC" style="border:1px solid #FFFFFF">Check: </td>
					<td class="texto" align="left" bgcolor="#CCCCCC" style="border:1px solid #FFFFFF"><input type="checkbox" name="checka" id="checka" value="1"';if($ResVenta["checka"]==1){$cadena.=' checked';}$cadena.='></td>
				</tr>
				<tr>
...
function editar_compra_tela($compra, $tela)
{
	...
	$cadena.='			</select>
				...
				<tr>
					<td class="texto" align="right" bgcolor="#CCCCCC" style="border:1px solid #FFFFFF">Check: </td>
					<td class="texto" align="left" bgcolor="#CCCCCC" style="border:1px solid #FFFFFF"><input type="checkbox" name="checka" id="checka" value="1"';if($ResCompra["checka"]==1){$cadena.=' checked';}$cadena.='></td>
				</tr>
				<tr>
					<td class="texto" align="right" bgcolor="#CCCCCC" style="border:1px solid #FFFFFF">Historico: </td>
...
function avios()
{
	...
	$cadena='<table style="border:1px solid #FFFFFF" cellpadding="3" cellspacing="0" align="center">
				<tr>
					<td colspan="11" bgcolor="#ffffff" align="right" class="texto" style="border:1px solid #FFFFFF">| <a href="#" onclick="xajax_agregar_avio()">Agregar Avio</a> |</td>
				</tr>
				<tr>
					<td colspan="11" bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">Avios</td>
				</tr>
				<tr>
					<td bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">#</td>
					<td bgcolor="#5263ab" align="center" class="texto3" style="border:1px solid #FFFFFF">Nombre</td>
	...
	$ResAvios=mysql_query("SELECT * FROM avios WHERE Status='1' ORDER BY Nombre ASC");
	$A=1; $T=1; $bgcolor="#CCCCCC";
